...
describe('extractPath', () => {
	...
	it('should return an array of strings when given a dot notation string (with brackets)', () => {
...
describe('setNested', () => {
	...
	it('should not mutate if path is empty', () => {
		const obj = { a: { b: { c: 1 } } };
...
describe('getInputValue', () => {
	...
	describe('alias functions', () => {
		...
		it('should return object keys', () => {
			expect(objectKeys({ a: '', b: '' })).toEqual(['a', 'b']);
		});
	});
